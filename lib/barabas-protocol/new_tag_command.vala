...
{
	public class NewTagCommand : ICommand
	{
		private SyncedFile file_to_sync;
		private string new_tag;
	
		public override string command_type { get { return "tag"; } }

		public NewTagCommand(SyncedFile file, string tag)
		{
			file_to_sync = file;
			new_tag = tag;
		}
		...
		public override Json.Generator? execute()
		{
			...
			tag_op.set_string_member("tag", new_tag);
		...
		{
			file_to_sync.tag_from_remote(new_tag);
		}
	}
}
